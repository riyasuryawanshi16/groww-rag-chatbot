git add .
git commit -m "Update app.py with RAG chatbot code"
git push origin main"""
Groww Mutual Fund FAQ Bot
Redesigned single-column, clean, minimal dark theme adhering strictly to specifications:
1. Big bold header: split-color "GROWW" (teal/green) + "MUTUAL FUND FAQ BOT" (white bold)
2. Gray subtitle: "AI-powered · Source-grounded answers."
3. Description line: "Ask factual questions about selected Groww mutual fund schemes..."
4. Three checkmarks: "✓ Facts only", "✓ Official sources", "✓ No investment advice"
5. Dashed-border badge: "⚠ Not investment advice"
6. "COVERING" section with 5 schemes as rounded pill chips
7. 3 max suggested question chips above the input, tappable to auto-fill
8. Single centered chat input with placeholder "Ask about these mutual funds..."
9. Zero sidebar clutter; collapsible "ℹ️ About this bot" expander closed by default
10. Grounding accuracy: strict facts-only, exact fallback "I don't have this information in my official sources.",
    max 3 sentences, exactly 1 citation link, "Last updated from sources:" line.
"""
