...
Implements multi-source fallback retrieval, embedded default corpus, exact matching,
...
# Comprehensive FAQ corpus covering SIP, Mutual Fund basics, and core topics
