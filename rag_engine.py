...
DEFAULT_MUTUAL_FUND_CORPUS = [
    {
        ...
        "url": "https://groww.in/blog/how-to-invest-in-sip"
    },
    {
        ...
        "url": "https://groww.in/blog/what-are-mutual-funds"
    },
    {
        "source_id": "faq_1",
        ...
        "url": "https://groww.in/blog/mutual-fund-cut-off-time"
    },
    {
        "source_id": "faq_2",
        ...
        "url": "https://groww.in/blog/elss-tax-saving-mutual-funds"
    },
    {
        "source_id": "faq_3",
        ...
        "url": "https://groww.in/blog/direct-vs-regular-mutual-funds"
    },
    {
        "source_id": "faq_4",
    ...
    },
    {
        ...
        "url": "https://groww.in/blog/large-cap-vs-flexi-cap-mutual-funds"
    }
]
...
class GrowwRAGEngine:
    ...
    def answer_query(self, query: str, filter_org: Optional[str] = None) -> Dict[str, Any]:
        ...
        sources_list = [{
            ...
            "url": item["doc"].get("url", "https://groww.in/blog"),
